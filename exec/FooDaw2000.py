...
WINE_ENV=confctl.confctl.glob[PFX]['WINE_ENV']
WINE_BIN=confctl.confctl.glob[PFX]['WINE_BIN']
...
b['exec']	=	f"{confctl.confctl.glob[PFX]['PATH']['path']}/drive_c/FooDAW2000/FooDAW2000/foobar2000/foobar2000.exe"
