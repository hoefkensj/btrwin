...
def load_sys_config():	return btrwin.modules.conf.load.ctl.sys_config(c=btrwin.lib.conf.new())
def load_user_configs():return btrwin.modules.conf.load.ctl.user_configs(c=btrwin.lib.conf.new())
def load_env_config():	return btrwin.modules.conf.load.ctl.env_config(c=btrwin.lib.conf.new())
